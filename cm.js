  ...
  inquirer.prompt([
    {
      type: "input",
      name: "id",
      message: "Enter the the ID of the product you would like to purchase?",
    ...
    },
    {
      ...
      if(res[whatToBuy].stock_quantity >= howMuchToBuy){
        ...
        //     if(deptRes[i].department_nm === res[whatToBuy].department_nm){
        //       index = i;
        //     }
        //   }
        ...
        //   {department_nm: res[whatToBuy].department_nm}
